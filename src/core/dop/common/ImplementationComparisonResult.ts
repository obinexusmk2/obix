...
import { ErrorSeverity } from '@/core/common/errors';
import { TraceComparisonResult } from '@/core/validation/errors';
...
export { ImplementationComparisonResult as ComparisonResult };
