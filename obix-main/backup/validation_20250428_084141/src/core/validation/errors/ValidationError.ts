...
import { ErrorSeverity } from "./ErrorHandler";
  ...
  export class ParserError extends ValidationErrorClass {
     * @returns This error for method chaining
     */
    public addTrace(entry: string): ValidationError {
      this.trace.push(entry);
      return this;
    }
     ...
     * @returns A new error with the added metadata
     */
    public withMetadata(metadata: Record<string, unknown>): ValidationError {
    ...
    /**
     * Creates a ValidationError from a plain object
     * 
     * @param obj The plain object
     * @returns A new ValidationError instance
     */
    public static fromObject(obj: unknown): ValidationError {
      const errorObj = obj as { 
        errorCode?: string;
        message?: string;
        component?: string;
   ...
   * Error representing a problem with the validation system itself
   */
  export class ValidationSystemError extends ValidationError {
    /**
